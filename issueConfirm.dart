...
class IssueConfirm extends StatefulWidget {
  late int p;
  IssueConfirm({this.p=0});
  List<List>list=[];
  @override
  State<IssueConfirm> createState() => _IssueConfirmState();
}

class _IssueConfirmState extends State<IssueConfirm> {
  ...
  Future<void> selectDate1(BuildContext context)async{
    ...
    if (_Date1 != null && _Date1 != Date1) {
      setState(() {
        Date1 = _Date1;
        searchcontroller2.text = Date1.toString().substring(0,10);
      });
    }
  }
  ...
  Future<void> selectDate2(BuildContext context)async{
    final DateTime? _Date2 = await showDatePicker(
      context: context,
      initialDate: DateTime.now(),
      firstDate: DateTime(2000),
      lastDate: DateTime(2099),
    ...
    if (_Date2 != null && _Date2 != Date1) {
      setState(() {
        Date2 = _Date2;
        searchcontroller3.text = Date2.toString().substring(0,10);
      });
    }
  }
  ...
  Future<void>autofill()async{
    ...
    {
      searchcontroller2.text=DateTime.now().toString().substring(0,10);
    }
    if(searchcontroller3.text.toString()=="")
    {
      ...
      searchcontroller3.text=nextMonthDate.toString().substring(0,10);
    }
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Text("Person Name:",style: TextStyle(fontSize: MediaQuery.of(context).size.height/25, fontWeight: FontWeight.w400),),
                              ],
                            ),
                          ),
                          SizedBox(width: MediaQuery.of(context).size.width/20),
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.fromLTRB(15, 5, 94, 5),
                            child: Column(
                              children: [
                                Text("Issue Date:",style: TextStyle(fontSize: MediaQuery.of(context).size.height/25, fontWeight: FontWeight.w400),),
                              ],
                            ),
                          ),
                          SizedBox(width: MediaQuery.of(context).size.width/20),
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.fromLTRB(15, 5, 70, 5),
                            child: Column(
                              children: [
                                Text("Return Date:",style: TextStyle(fontSize: MediaQuery.of(context).size.height/25, fontWeight: FontWeight.w400),),
                              ],
                            ),
                          ),
                          SizedBox(width: MediaQuery.of(context).size.width/20),
                        ...
                        children: <Widget>[
                          ...
                          ElevatedButton(
                            ...
                            onPressed: ()async{
                              ...
                              var excel = Excel.decodeBytes(bytes);
                              var sheet = excel.tables.values.first;
                              if(searchcontroller1.text=="" || searchcontroller2.text=="" || searchcontroller3.text=="")
                                {
                                ...
                                {
                                  sheet.rows[widget.p][6]?.value="Yes";
                                  sheet.rows[widget.p][7]?.value=searchcontroller1.text.toString();
                                  sheet.rows[widget.p][8]?.value=searchcontroller2.text.toString();
                                  sheet.rows[widget.p][9]?.value=searchcontroller3.text.toString();
                                  var updatedBytes = excel.encode();
                                  await File(filePath).writeAsBytes(updatedBytes!);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text("Book Issued")),
                                  );
